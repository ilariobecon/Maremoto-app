...
spots = [
    ...
    {'name': 'Circeo Promontorio', 'lat': 41.2333, 'lon': 13.0667, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Polpo', 'Sardina', 'Gambero'], 'percentuali': {'Polpo': 40, 'Sardina': 30, 'Gambero': 30}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Sabaudia Spiaggia', 'lat': 41.3000, 'lon': 13.0167, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Cozza', 'Sardina'], 'percentuali': {'Arenicola': 45, 'Cozza': 35, 'Sardina': 20}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Cefalo'], 'pastura': 'Pastura con arenicola e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Ladispoli Scogliere', 'lat': 41.9500, 'lon': 12.0667, 'techniques': ['Spinning'], 'premium': False, 'esche': ['Gamberetto', 'Verme', 'Polpo'], 'percentuali': {'Gamberetto': 50, 'Verme': 30, 'Polpo': 20}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Triglia'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Riva di Traiano', 'lat': 42.1000, 'lon': 11.7667, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Verme', 'Gambero', 'Cozza'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Cozza': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Mormora'], 'pastura': 'Pastura fine con bigattino e pane', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Ostia Lido', 'lat': 41.7333, 'lon': 12.2667, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Sardina', 'Arenicola', 'Gambero'], 'percentuali': {'Sardina': 40, 'Arenicola': 30, 'Gambero': 30}, 'prede': ['Spigola', 'Mormora', 'Orata', 'Cefalo'], 'pastura': 'Pastura densa con sardina per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Torvaianica', 'lat': 41.6333, 'lon': 12.4667, 'techniques': ['Surfcasting', 'Spinning'], 'premium': True, 'esche': ['Cozza', 'Verme', 'Sardina'], 'percentuali': {'Cozza': 40, 'Verme': 30, 'Sardina': 30}, 'prede': ['Orata', 'Sarago', 'Spigola', 'Triglia'], 'pastura': 'Pastura mista cozza e sardina', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Nettuno Porto', 'lat': 41.4500, 'lon': 12.6667, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Gambero', 'Polpo', 'Arenicola'], 'percentuali': {'Gambero': 50, 'Polpo': 30, 'Arenicola': 20}, 'prede': ['Sarago', 'Grongo', 'Spigola', 'Sgombro'], 'pastura': 'Pastura con gambero e sardina per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Gaeta Scogli', 'lat': 41.2000, 'lon': 13.5667, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Sardina', 'Verme', 'Cozza'], 'percentuali': {'Sardina': 40, 'Verme': 30, 'Cozza': 30}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Cefalo'], 'pastura': 'Pasturazione con sardina per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},

    # Campania (11 spot)
    {'name': 'Palinuro Scogliere', 'lat': 40.0333, 'lon': 15.2833, 'techniques': ['Pesca a fondo dagli scogli/porto', 'Spinning'], 'premium': False, 'esche': ['Polpo', 'Gambero', 'Verme'], 'percentuali': {'Polpo': 40, 'Gambero': 30, 'Verme': 30}, 'prede': ['Grongo', 'Spigola', 'Sarago', 'Triglia'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Acciaroli Porto', 'lat': 40.1833, 'lon': 15.0333, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Cozza', 'Sardina', 'Arenicola'], 'percentuali': {'Cozza': 40, 'Sardina': 30, 'Arenicola': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Cefalo'], 'pastura': 'Pastura fine con cozza per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    ...
    {'name': 'Cilento Costa', 'lat': 40.2000, 'lon': 15.0000, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Cozza', 'Polpo'], 'percentuali': {'Arenicola': 40, 'Cozza': 35, 'Polpo': 25}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Sgombro'], 'pastura': 'Pastura con arenicola e sardina per lunghe distanze', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Agropoli Molo', 'lat': 40.3500, 'lon': 14.9833, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Verme', 'Gambero', 'Sardina'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Sardina': 30}, 'prede': ['Sarago', 'Orata', 'Grongo', 'Triglia'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Salerno Lungomare', 'lat': 40.6667, 'lon': 14.7667, 'techniques': ['Spinning'], 'premium': False, 'esche': ['Gambero', 'Verme', 'Cozza'], 'percentuali': {'Gambero': 50, 'Verme': 30, 'Cozza': 20}, 'prede': ['Spigola', 'Sarago', 'Orata', 'Cefalo'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Amalfi Scogli', 'lat': 40.6333, 'lon': 14.6000, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Polpo', 'Sardina', 'Gambero'], 'percentuali': {'Polpo': 40, 'Sardina': 30, 'Gambero': 30}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Castellabate Spiaggia', 'lat': 40.2833, 'lon': 14.9500, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Arenicola', 'Cozza', 'Verme'], 'percentuali': {'Arenicola': 40, 'Cozza': 30, 'Verme': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Triglia'], 'pastura': 'Pastura con arenicola e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Napoli Bay Scogliere', 'lat': 40.8333, 'lon': 14.2500, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Sardina', 'Gambero', 'Polpo'], 'percentuali': {'Sardina': 40, 'Gambero': 30, 'Polpo': 30}, 'prede': ['Sarago', 'Grongo', 'Spigola', 'Cefalo'], 'pastura': 'Pasturazione con sardina per fondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Ischia Porto', 'lat': 40.7333, 'lon': 13.9500, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Cozza', 'Verme', 'Arenicola'], 'percentuali': {'Cozza': 50, 'Verme': 30, 'Arenicola': 20}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Mormora'], 'pastura': 'Pastura fine con cozza per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Sorrento Punta', 'lat': 40.6167, 'lon': 14.3667, 'techniques': ['Spinning'], 'premium': True, 'esche': ['Gambero', 'Sardina', 'Verme'], 'percentuali': {'Gambero': 40, 'Sardina': 30, 'Verme': 30}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Sgombro'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},

    # Puglia (12 spot)
    {'name': 'Vieste Gargano', 'lat': 41.8833, 'lon': 16.1667, 'techniques': ['Pesca a fondo dagli scogli/porto', 'Spinning'], 'premium': False, 'esche': ['Polpo', 'Gambero', 'Verme'], 'percentuali': {'Polpo': 40, 'Gambero': 30, 'Verme': 30}, 'prede': ['Grongo', 'Spigola', 'Sarago', 'Triglia'], 'pastura': 'Pasturazione con polpo per fondo', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Peschici Scogliere', 'lat': 41.9500, 'lon': 16.0167, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Sardina', 'Cozza', 'Gamberetto'], 'percentuali': {'Sardina': 40, 'Cozza': 30, 'Gamberetto': 30}, 'prede': ['Sarago', 'Ombrina', 'Grongo', 'Cefalo'], 'pastura': 'Pasturazione con sardina per fondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Otranto Porto', 'lat': 40.1500, 'lon': 18.4833, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Verme', 'Arenicola', 'Sardina'], 'percentuali': {'Verme': 40, 'Arenicola': 30, 'Sardina': 30}, 'prede': ['Orata', 'Sarago', 'Spigola', 'Mormora'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Polignano Scogliere', 'lat': 40.9667, 'lon': 17.2167, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Gambero', 'Polpo', 'Cozza'], 'percentuali': {'Gambero': 50, 'Polpo': 30, 'Cozza': 20}, 'prede': ['Grongo', 'Sarago', 'Ombrina', 'Sgombro'], 'pastura': 'Pasturazione con gambero per fondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Torre dell\'Orso Spiaggia', 'lat': 40.2667, 'lon': 18.4333, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Sardina', 'Verme'], 'percentuali': {'Arenicola': 40, 'Sardina': 30, 'Verme': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Triglia'], 'pastura': 'Pastura con arenicola e sardina per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Taranto Golfo', 'lat': 40.4667, 'lon': 17.2333, 'techniques': ['Surfcasting', 'Spinning'], 'premium': False, 'esche': ['Cozza', 'Gambero', 'Polpo'], 'percentuali': {'Cozza': 40, 'Gambero': 30, 'Polpo': 30}, 'prede': ['Spigola', 'Orata', 'Sarago', 'Cefalo'], 'pastura': 'Pastura mista cozza e sardina', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Gallipoli Molo', 'lat': 40.0500, 'lon': 17.9833, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Verme', 'Sardina', 'Arenicola'], 'percentuali': {'Verme': 40, 'Sardina': 30, 'Arenicola': 30}, 'prede': ['Sarago', 'Orata', 'Grongo', 'Sgombro'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Leuca Punta', 'lat': 39.8000, 'lon': 18.3500, 'techniques': ['Pesca a fondo dagli scogli/porto', 'Spinning'], 'premium': True, 'esche': ['Gambero', 'Cozza', 'Verme'], 'percentuali': {'Gambero': 50, 'Cozza': 30, 'Verme': 20}, 'prede': ['Spigola', 'Sarago', 'Ombrina', 'Triglia'], 'pastura': 'Pastura leggera con gambero per spinning', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Manfredonia Spiaggia', 'lat': 41.6333, 'lon': 15.9167, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Arenicola', 'Polpo', 'Sardina'], 'percentuali': {'Arenicola': 40, 'Polpo': 30, 'Sardina': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Cefalo'], 'pastura': 'Pastura con arenicola e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Barletta Litorale', 'lat': 41.3167, 'lon': 16.2833, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Cozza', 'Verme', 'Gambero'], 'percentuali': {'Cozza': 40, 'Verme': 30, 'Gambero': 30}, 'prede': ['Orata', 'Sarago', 'Spigola', 'Grongo'], 'pastura': 'Pastura mista cozza e sardina', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Monopoli Calette', 'lat': 40.9500, 'lon': 17.3000, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Sardina', 'Polpo', 'Arenicola'], 'percentuali': {'Sardina': 40, 'Polpo': 30, 'Arenicola': 30}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con sardina per fondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Brindisi Porto', 'lat': 40.6333, 'lon': 17.9333, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Gambero', 'Verme', 'Cozza'], 'percentuali': {'Gambero': 50, 'Verme': 30, 'Cozza': 20}, 'prede': ['Sarago', 'Spigola', 'Orata', 'Triglia'], 'pastura': 'Pastura fine con gambero per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},

    # Sicilia (11 spot)
    {'name': 'Taormina Bay', 'lat': 37.8500, 'lon': 15.2833, 'techniques': ['Spinning', 'Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Gambero', 'Sardina', 'Verme'], 'percentuali': {'Gambero': 40, 'Sardina': 30, 'Verme': 30}, 'prede': ['Spigola', 'Sarago', 'Orata', 'Sgombro'], 'pastura': 'Pastura leggera con gambero per spinning', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Sciacca Porto', 'lat': 37.5000, 'lon': 13.0833, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Cozza', 'Arenicola', 'Polpo'], 'percentuali': {'Cozza': 40, 'Arenicola': 30, 'Polpo': 30}, 'prede': ['Sarago', 'Orata', 'Grongo', 'Triglia'], 'pastura': 'Pastura fine con cozza per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Lampedusa Cala Pulcino', 'lat': 35.5000, 'lon': 12.6000, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Verme', 'Gambero', 'Sardina'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Sardina': 30}, 'prede': ['Orata', 'Sarago', 'Ombrina', 'Cefalo'], 'pastura': 'Pasturazione con verme per fondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Favignana Egadi', 'lat': 37.9333, 'lon': 12.3167, 'techniques': ['Spinning'], 'premium': False, 'esche': ['Sardina', 'Gamberetto', 'Polpo'], 'percentuali': {'Sardina': 50, 'Gamberetto': 30, 'Polpo': 20}, 'prede': ['Spigola', 'Grongo', 'Sarago', 'Sgombro'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Capo Peloro', 'lat': 38.2667, 'lon': 15.6333, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Cozza', 'Verme'], 'percentuali': {'Arenicola': 40, 'Cozza': 30, 'Verme': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Triglia'], 'pastura': 'Pastura con arenicola per lunghe distanze', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Catania Moli', 'lat': 37.5000, 'lon': 15.0833, 'techniques': ['Bolognese', 'Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Gambero', 'Sardina', 'Polpo'], 'percentuali': {'Gambero': 40, 'Sardina': 30, 'Polpo': 30}, 'prede': ['Sarago', 'Grongo', 'Spigola', 'Cefalo'], 'pastura': 'Pastura mista gambero e sardina', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Siracusa Porto', 'lat': 37.0667, 'lon': 15.2833, 'techniques': ['Spinning'], 'premium': True, 'esche': ['Verme', 'Gambero', 'Cozza'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Cozza': 30}, 'prede': ['Spigola', 'Sarago', 'Orata', 'Mormora'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Trapani Scogliere', 'lat': 38.0167, 'lon': 12.5167, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Polpo', 'Sardina', 'Arenicola'], 'percentuali': {'Polpo': 50, 'Sardina': 30, 'Arenicola': 20}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Palermo Lungomare', 'lat': 38.1167, 'lon': 13.3667, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Cozza', 'Verme', 'Gambero'], 'percentuali': {'Cozza': 40, 'Verme': 30, 'Gambero': 30}, 'prede': ['Orata', 'Sarago', 'Spigola', 'Triglia'], 'pastura': 'Pastura con cozza e sardina per lunghe distanze', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Cefalù Spiaggia', 'lat': 38.0333, 'lon': 14.0167, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Arenicola', 'Sardina', 'Polpo'], 'percentuali': {'Arenicola': 40, 'Sardina': 30, 'Polpo': 30}, 'prede': ['Orata', 'Mormora', 'Sarago', 'Cefalo'], 'pastura': 'Pastura con arenicola e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Messina Stretto', 'lat': 38.2000, 'lon': 15.5500, 'techniques': ['Spinning'], 'premium': True, 'esche': ['Gambero', 'Verme', 'Cozza'], 'percentuali': {'Gambero': 50, 'Verme': 30, 'Cozza': 20}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Sgombro'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '10-15m', 'difficolta': 'difficile'},

    # Sardegna (11 spot)
    {'name': 'Alghero Litorale', 'lat': 40.5667, 'lon': 8.3167, 'techniques': ['Surfcasting', 'Spinning'], 'premium': False, 'esche': ['Arenicola', 'Gambero', 'Sardina'], 'percentuali': {'Arenicola': 40, 'Gambero': 30, 'Sardina': 30}, 'prede': ['Orata', 'Spigola', 'Sarago', 'Cefalo'], 'pastura': 'Pastura con arenicola e sardina per surfcasting', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Stintino Spiaggia', 'lat': 40.9333, 'lon': 8.2333, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Cozza', 'Verme', 'Arenicola'], 'percentuali': {'Cozza': 45, 'Verme': 35, 'Arenicola': 20}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Triglia'], 'pastura': 'Pastura con cozza e formaggio per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Capo Falcone', 'lat': 41.0000, 'lon': 8.4000, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': False, 'esche': ['Polpo', 'Sardina', 'Gambero'], 'percentuali': {'Polpo': 40, 'Sardina': 30, 'Gambero': 30}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Golfo Aranci Spiaggia Bianca', 'lat': 40.9833, 'lon': 9.6167, 'techniques': ['Surfcasting', 'Bolognese'], 'premium': False, 'esche': ['Verme', 'Cozza', 'Gamberetto'], 'percentuali': {'Verme': 40, 'Cozza': 30, 'Gamberetto': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Cefalo'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Villasimius Capo Carbonara', 'lat': 39.1167, 'lon': 9.5167, 'techniques': ['Spinning'], 'premium': False, 'esche': ['Gambero', 'Sardina', 'Verme'], 'percentuali': {'Gambero': 50, 'Sardina': 30, 'Verme': 20}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Triglia'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Cagliari Poetto', 'lat': 39.2000, 'lon': 9.1500, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Cozza', 'Polpo'], 'percentuali': {'Arenicola': 40, 'Cozza': 30, 'Polpo': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Cefalo'], 'pastura': 'Pastura con arenicola e sardina per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Badesi Spiaggia', 'lat': 40.9667, 'lon': 8.8833, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Sardina', 'Gambero', 'Verme'], 'percentuali': {'Sardina': 40, 'Gambero': 30, 'Verme': 30}, 'prede': ['Orata', 'Spigola', 'Sarago', 'Mormora'], 'pastura': 'Pastura densa con sardina e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Capo Caccia Scogliere', 'lat': 40.5667, 'lon': 8.1667, 'techniques': ['Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Polpo', 'Cozza', 'Arenicola'], 'percentuali': {'Polpo': 50, 'Cozza': 30, 'Arenicola': 20}, 'prede': ['Grongo', 'Ombrina', 'Sarago', 'Sgombro'], 'pastura': 'Pasturazione con polpo per fondo profondo', 'fondale': 'scogli', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Olbia Porto', 'lat': 40.9167, 'lon': 9.5000, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Verme', 'Gambero', 'Sardina'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Sardina': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Cefalo'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'La Maddalena Arcipelago', 'lat': 41.2167, 'lon': 9.4000, 'techniques': ['Spinning', 'Pesca a fondo dagli scogli/porto'], 'premium': True, 'esche': ['Gamberetto', 'Polpo', 'Cozza'], 'percentuali': {'Gamberetto': 40, 'Polpo': 30, 'Cozza': 30}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Triglia'], 'pastura': 'Pastura leggera con gamberetto per spinning', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'intermedio'},
    {'name': 'Chia Spiaggia', 'lat': 38.8833, 'lon': 8.8833, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Arenicola', 'Sardina', 'Verme'], 'percentuali': {'Arenicola': 40, 'Sardina': 30, 'Verme': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Cefalo'], 'pastura': 'Pastura con arenicola e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},

    # Emilia-Romagna / Veneto (11 spot)
    {'name': 'Cesenatico Molo', 'lat': 44.2000, 'lon': 12.4000, 'techniques': ['Bolognese', 'Spinning'], 'premium': False, 'esche': ['Verme', 'Gambero', 'Cozza'], 'percentuali': {'Verme': 40, 'Gambero': 30, 'Cozza': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Cefalo'], 'pastura': 'Pastura fine con bigattino per bolognese', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Cervia Spiaggia', 'lat': 44.2667, 'lon': 12.3500, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Sardina', 'Polpo'], 'percentuali': {'Arenicola': 40, 'Sardina': 30, 'Polpo': 30}, 'prede': ['Orata', 'Mormora', 'Sarago', 'Triglia'], 'pastura': 'Pastura con arenicola e sardina per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Rimini Diga', 'lat': 44.0667, 'lon': 12.5667, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Cozza', 'Verme', 'Gambero'], 'percentuali': {'Cozza': 40, 'Verme': 30, 'Gambero': 30}, 'prede': ['Spigola', 'Orata', 'Sarago', 'Cefalo'], 'pastura': 'Pastura mista cozza e sardina', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Lignano Riviera', 'lat': 45.6833, 'lon': 13.1167, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Sardina', 'Arenicola', 'Polpo'], 'percentuali': {'Sardina': 40, 'Arenicola': 30, 'Polpo': 30}, 'prede': ['Orata', 'Spigola', 'Mormora', 'Cefalo'], 'pastura': 'Pastura con sardina e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Chioggia Laguna', 'lat': 45.2167, 'lon': 12.2833, 'techniques': ['Bolognese'], 'premium': False, 'esche': ['Gambero', 'Verme', 'Cozza'], 'percentuali': {'Gambero': 50, 'Verme': 30, 'Cozza': 20}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Mormora'], 'pastura': 'Pastura fine con gambero per bolognese', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Bellaria Spiaggia', 'lat': 44.1333, 'lon': 12.4667, 'techniques': ['Surfcasting'], 'premium': False, 'esche': ['Arenicola', 'Sardina', 'Gambero'], 'percentuali': {'Arenicola': 40, 'Sardina': 30, 'Gambero': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Triglia'], 'pastura': 'Pastura con arenicola e sardina per lunghe distanze', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Marina di Ravenna Diga', 'lat': 44.4833, 'lon': 12.2833, 'techniques': ['Spinning'], 'premium': True, 'esche': ['Verme', 'Polpo', 'Cozza'], 'percentuali': {'Verme': 40, 'Polpo': 30, 'Cozza': 30}, 'prede': ['Spigola', 'Sarago', 'Grongo', 'Sgombro'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Porto Garibaldi', 'lat': 44.6833, 'lon': 12.2333, 'techniques': ['Bolognese'], 'premium': True, 'esche': ['Gambero', 'Sardina', 'Verme'], 'percentuali': {'Gambero': 40, 'Sardina': 30, 'Verme': 30}, 'prede': ['Sarago', 'Orata', 'Spigola', 'Cefalo'], 'pastura': 'Pastura fine con gambero per bolognese', 'fondale': 'misto', 'profondita': '5-10m', 'difficolta': 'semplice'},
    {'name': 'Comacchio Canali', 'lat': 44.7000, 'lon': 12.1833, 'techniques': ['Spinning'], 'premium': True, 'esche': ['Cozza', 'Polpo', 'Arenicola'], 'percentuali': {'Cozza': 50, 'Polpo': 30, 'Arenicola': 20}, 'prede': ['Spigola', 'Grongo', 'Sarago', 'Triglia'], 'pastura': 'Pastura minima – spinning puro', 'fondale': 'misto', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Caorle Spiaggia', 'lat': 45.6000, 'lon': 12.8833, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Sardina', 'Gambero', 'Verme'], 'percentuali': {'Sardina': 40, 'Gambero': 30, 'Verme': 30}, 'prede': ['Orata', 'Mormora', 'Spigola', 'Cefalo'], 'pastura': 'Pastura con sardina e formaggio', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
    {'name': 'Jesolo Lido', 'lat': 45.5167, 'lon': 12.6667, 'techniques': ['Surfcasting'], 'premium': True, 'esche': ['Arenicola', 'Cozza', 'Polpo'], 'percentuali': {'Arenicola': 40, 'Cozza': 30, 'Polpo': 30}, 'prede': ['Orata', 'Sarago', 'Spigola', 'Triglia'], 'pastura': 'Pastura con arenicola e sardina', 'fondale': 'sabbioso', 'profondita': '2-5m', 'difficolta': 'semplice'},
